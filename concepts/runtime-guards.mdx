---
title: "Runtime Invariant Guards for Soroban Contracts"
...
For more comprehensive invariant enforcement, wrap mutating logic in a helper that checks state both before and after the operation:
