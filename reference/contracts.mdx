---
title: "Example Soroban Contracts and Security Templates"
...
| Formal verification harnesses | 6 | Kani |
...
- `attempt_initialize(is_initialized: bool) -> Result<(), &'static str>` — pure function verified to reject double-initialization for all possible boolean inputs.
...
```rust
pub fn init(env: Env, verifying_key: Bytes)
